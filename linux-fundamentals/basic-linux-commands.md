---
description: >-
  Note: In these, and all other examples in the cheatsheets, the $ prefix before
  a command indicates the use of a linux command line input. It is not part of
  the command - it is there to show you which
---
